...
C                                                                         
 2001 FORMAT(' CUBM QMIN APPLIED: I,J,L,NCRB,NCRT,QG = ',5I5,F10.4)       
 2002 FORMAT(' CUBM QMIN APPLIED FOR QM: I,J,NCRB,NCRT,QM = ',4I5,F10.4)  
 2004 FORMAT(' CUBM MID LEVEL SWAP IGNORED: I,J,NCRB,NCRT =',4I5)         
...
C shallow convection                                                      
      ICFLAG(J,4,1)=NCRB                                                  
      ICFLAG(J,4,2)=NCRT                                                  
      CFRAC(J,4)=0.35  ! cloud fraction for all shallow convection        
      NLEV=1+NCRB-NCRT                                                    
      RKAP=1.0/AKAP                                                       
      DO 10 L=NCRT,NCRB                                                   
       PL(L)=SIGMA(L)*PLG(J)                                              
...
C calculations.                                                           
C       IF (QG(J,L).LT.QGMIN) THEN                                        
C         WRITE(2,2001) J,JH,L,NCRB,NCRT,CQ*QG(J,L)                       
C       ENDIF                                                             
...
C      IF (QM.LT.QGMIN) THEN                                              
C         WRITE(2,2002) J,JH,NCRB,NCRT,CQ*QM                              
C      ENDIF                                                              
      QM=MAX(QM,QGMIN)                                                    
      TMT=THM*PFK(NCRT)                                                   
