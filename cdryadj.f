...
C ER Modif for ability to use soft adjustment for dry convection
C (Instead of default: hard adjustment, on timescale of timestep)
      REAL ATSTEP
C                                                                         
C                                                                         

C ER Modif to set convective adjustment timescale
      IF (CBADJT.EQ.0) THEN 
         ATSTEP=DELT2C
      ELSE
         ATSTEP=CBADJT
