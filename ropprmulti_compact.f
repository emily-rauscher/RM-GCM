...
!   Simple cloud test:
      ...
      REAL MOLEF(13),DENSITY(13),RPS(NL),TAUFACT
      ...
      INTEGER K,JJ,J,NCLOUD,AERLAYERS,BASELEV,TOPLEV
...
!     PRESSMID- PRESSURE AT CENTER OF LAYER (dyne/cm^2
      ...
      Do 200  I         = 1,NCLOUD
       DO 180  J          =   1,NLAYER-1
        ...
        TAUFACT=  DPG(J)*10.*molef(I)*3./4./rps(J)/density(I)
     &            *CONDFACT(J,I)
...
180   CONTINUE
        ...
        DO 185  J       = 1,TOPLEV
         ...
         TAUAERLW(J,I)       = 0.
185   CONTINUE
         write(*,*),'BASELEV',BASELEV
         write(*,*),'TOPLEV',TOPLEV
         write(*,*),'AERLAYERS',AERLAYERS
         DO J = 1,NLEV 
         WRITE(*,*), 'TAUAER',TAUAERSW(J,I),TAUAERLW(J,I)
200   CONTINUE
      stop
