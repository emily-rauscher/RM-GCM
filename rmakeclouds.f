...
!      *****************************************************************
     ...
     &   MAXTAU,MAXTAULOC,TCON,AEROSOLCOMP,HAZETYPE,MTLX,METALLICITY,
     &   HAZES,PICKET_FENCE_CLOUDS,MOLEF,AERLAYERS
...
!      NOT FOR THE SUBSEQUENT COMPUTATIONS. FILE WILL BE FORT.61
       ...
       WRITE(61,*) 'HAZETYPE (printing from rmakeclouds): ',HAZETYPE
       WRITE(61,*) 'Parameters:'
